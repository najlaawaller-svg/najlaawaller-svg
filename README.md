...
Meu nome é Najla Amaral Waller, tenho 17 anos e sou estudante de Engenharia da Computação no CEUB. Desde cedo desenvolvi interesse por construção de máquinas, hardware e tecnologia, ampliando posteriormente meu interesse para programação e desenvolvimento de software.
...
- Participação no INMACK (Simulação ONU)
- Aula de Consciência Ambiental — SENAI
- Projeto voluntário com crianças
- Projeto voluntário no Umanizzare
- Clube de Robótica escolar
